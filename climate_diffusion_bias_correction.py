...
# # change: 11.09: uncomment random split for train/valid -> just use stage=train/valid
...
dataloader_train_slp = data.DataLoader(all_data_slp, batch_size=wandb.config.batch_size, shuffle=False, drop_last=True,
...
dataloader_train_v850 = data.DataLoader(all_data_v850, batch_size=wandb.config.batch_size, shuffle=False, drop_last=True,
                               num_workers=wandb.config.num_workers)
...
dataloader_train_u850 = data.DataLoader(all_data_u850, batch_size=wandb.config.batch_size, shuffle=False, drop_last=True,
                               num_workers=wandb.config.num_workers)
...
compare_original_slp = compare_original_slp.data()


dataloader_original_val_snap_slp = data.DataLoader(compare_original_slp, batch_size=bs_valid, shuffle=False, drop_last=True,
                                     num_workers=wandb.config.num_workers)

compare_original_u = U850_Dataset(stage='valid')
compare_original_u.get_mean_std()
compare_original_u = compare_original_u.data()


dataloader_original_val_snap_u850 = data.DataLoader(compare_original_u, batch_size=bs_valid, shuffle=False, drop_last=True,
                                     num_workers=wandb.config.num_workers)

compare_original_v = V850_Dataset(stage='valid')
compare_original_v.get_mean_std()
compare_original_v = compare_original_v.data()


dataloader_original_val_snap_v850 = data.DataLoader(compare_original_v, batch_size=bs_valid, shuffle=False, drop_last=True,
                                     num_workers=wandb.config.num_workers)
